...
<body>
    <div class="ticket">
        ...
        <div class="ticket-body">
            <!-- Eliminar campos Nombre, Apellido, Año y Fecha -->
            <p class="hidden"><strong>Nombre del Cliente:</strong> {{ $booking->nombre_cliente }}</p>
            <p class="hidden"><strong>Apellido del Cliente:</strong> {{ $booking->apellido_cliente }}</p>
            <p class="hidden"><strong>Año:</strong> {{ $booking->anio }}</p>
            <p class="hidden"><strong>Fecha del Booking:</strong> {{ $booking->fecha }}</p>
